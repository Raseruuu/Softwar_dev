...
init python:
    def CardDisplay(cardobj):
        return At(Composite(
            ...
            (60,238),At(Text( "{size=14}{b}POWR: {/size}{color=#ae81f2}{font=font/consolas.ttf}{size=14}{k=-1}"+str(cardobj.POW)+"{/k}{/color}{/font}{/size}{/b}",style="cardshadows", layout="nobreak"),card_highlights_t),
