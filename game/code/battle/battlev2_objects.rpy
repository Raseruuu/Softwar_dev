...
#Force
    ...
    BitBuster=     Card("BitBuster",      "Gun",         0.5,     [Attack(rangevalue=7,onhit=[ReduceBit(1)])],   4)
    MachineBuster= Card("MachineBuster",      "Gun",     1.0,     [Attack()],   4)
    Excalibrium=   Card("Excalibrium",      "Sword",     1.0,     [Attack()],   4)
    ILYFlash=      Card("ILYFlash",      "Power",        1.0,     [Attack()],   4)
    BruiseBash=    Card("BruiseBash",      "Skill",      1.0,     [Attack(),GiveToken("DecreaseDEF",1)],   4)
