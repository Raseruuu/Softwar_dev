...
label maptalk_ProgramKun2:
    ...
    i "A short-range attack?"
    "Program-Kun" "Yeah.. some {b}\"attack()\"{/b} functions will have \" range=0 \". That's a short-range attack."
    extend " You gotta watch out for the DISTANCE variable in battle!"
